            ...
            <div class="container-fluid" id="barra">
                ...
                <div class="container-fluid" >
                    <form class="d-flex" role="search" >
                        <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" id="botton">
                        <button class="btn btn-outline-success" type="submit" id="botton">Buscar</button>
                    </form>
                </div>
