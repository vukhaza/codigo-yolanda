...
<body>
    ...
    <header>
            <nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary" style="background-color: #84A9C4;">
    ...
    <div class="container" id="body">
        ...
        <div class="card mx-auto" style="width: 18rem;" >
            <div class="card-header text-center" id="caja">Inicio de sesion</div>
            <div class="card-body"  id="caja">
                ...
                <a type="button" class="btn btn-success" id="boton">Iniciar Sesion</a>
